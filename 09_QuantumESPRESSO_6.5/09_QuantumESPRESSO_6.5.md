 ...
 * [ ] /opt/software/EasyBuild/4.2.2/easybuild/easyconfigs/l/libxc/libxc-4.3.4-GCC-8.3.0.eb (module: libxc/4.3.4-GCC-8.3.0)
 ...
 * [ ] /opt/software/EasyBuild/4.2.2/easybuild/easyconfigs/e/ELPA/ELPA-2019.11.001-foss-2019b.eb (module: ELPA/2019.11.001-foss-2019b)
 * [ ] /tmp/eb-2pXf0a/tweaked_easyconfigs/QuantumESPRESSO-6.5-foss-2019b.eb (module: QuantumESPRESSO/6.5-foss-2019b)
```
...
eb SRCs/QuantumESPRESSO-6.5-intel-2019b.eb --try-toolchain=foss,2019b --robot --package
```
...
Please note that the original installation of this version has used the intel compiler as toolchain, and we have changed that to foss,2019b which worked well.
