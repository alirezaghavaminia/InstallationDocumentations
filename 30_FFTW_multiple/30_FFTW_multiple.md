...
This package has been used frequently as dependency for other software, hence we have multiple versions of it.

## Easyconfig file

`FFTW-3.3.8-gompi-2020a.eb`
...
eb FFTW-3.3.8-gompi-2020a.eb --robot --package
```
