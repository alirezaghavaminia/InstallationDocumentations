# Installing DL-POLY-classic

It is the free version of DL-poly.

## Easyconfig file

`DL_POLY_Classic-1.10-foss-2019b.eb`
 ...
 * [ ] /opt/software/EasyBuild/4.2.2/easybuild/easyconfigs/d/DL_POLY_Classic/DL_POLY_Classic-1.10-foss-2019b.eb (module: DL_POLY_Classic/1.10-foss-2019b)
```
...
eb DL_POLY_Classic-1.10-foss-2019b.eb --robot --package
```
